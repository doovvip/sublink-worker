...
export async function handleTaobaoPricePage(request) {
  ...
  try{
    ...
    return json({ok:false,itemId:resolved.itemId,canonical,fallbackUrl,message:'历史价格源暂时没有返回可靠的结构化数据',detail:errors.slice(0,2)},502);
